    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Join your café's roster</p>
        </div>

        <form onSubmit={handleSignup} className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
          {error && (
